...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("branch_ids",        postgresql.ARRAY(sa.Integer()),
                  nullable=False, server_default="{}"),
        sa.Column("status",
                  postgresql.ENUM("active", "fired", "blocked", "trial",
    ...
    op.create_table(
        ...
        sa.Column("position",   sa.Integer(),     nullable=False, server_default="0"),
        sa.Column("status",
                  postgresql.ENUM("draft", "published",
    ...
    op.create_table(
        ...
        sa.Column("status",
                  postgresql.ENUM("in_training", "base_certified", "full_certified",
                          "blocked", "failed",
    ...
    op.create_table(
        ...
        sa.Column("result",
                  postgresql.ENUM("pending", "passed", "failed",
    ...
    op.create_table(
        ...
        sa.Column("status",
                  postgresql.ENUM("permitted", "not_permitted",
    ...
    op.create_table(
        ...
        sa.Column("integration_type",
                  postgresql.ENUM("yclients", "bitrix24", "analytics",
