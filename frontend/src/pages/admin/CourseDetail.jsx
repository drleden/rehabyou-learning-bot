  ...
  return (
    <div className="bg-white min-h-screen pb-8">
            ...
            <div key={module.id} className="bg-surface rounded-2xl overflow-hidden">
              ...
              >
                <div className="flex items-center gap-2 flex-1 min-w-0">
                  ...
                  <span className="text-xs text-gray-400 flex-shrink-0">{module.lessons?.length || 0} уроков</span>
                </div>
                <button
      ...
      {showAddModule && (
        <AddModuleSheet
          courseId={course.id}
          nextOrder={(course.modules?.length || 0)}
      ...
      {addLessonModuleId && (
        <AddLessonSheet
          ...
          nextOrder={course.modules?.find((m) => m.id === addLessonModuleId)?.lessons?.length || 0}
